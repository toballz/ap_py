...
try:
 ...
 wlan_ap = input("[??] Input wireless adapter's name:("+os.listdir('sys/class/net/')[2]+") ") or os.listdir('sys/class/net/')[2]
 eth_ap = input("[??] Input internet access point name:("+os.listdir('sys/class/net/')[1]+") ") or os.listdir('sys/class/net/')[1]
